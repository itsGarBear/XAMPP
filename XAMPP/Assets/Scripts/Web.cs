...
public class Web : MonoBehaviour
{
    void Start()
    {
        ...
        StartCoroutine(GetUsers("http://localhost/UnityBackendTutorial/GetItemsIDs.php"));
    ...
    public IEnumerator GetItemsIDs(string uri, string userID, System.Action<string> callback)
    {
        WWWForm form = new WWWForm();
    ...
    public IEnumerator GetItem(string uri, string itemID, System.Action<string> callback)
    {
        WWWForm form = new WWWForm();
